...
struct CirclesView: View {
    ...
    @State var selectedColourTwo = Color.blue
    @State var selectedColourThree = Color.purple
    @State var selectedColourFour = Color.green
    @State var selectedColourFive = Color.yellow
    @State var selectedColourSix = Color.pink
        ...
        NavigationView {
            ...
            VStack {
                ...
                VStack {
                    ...
                    ColorPicker("Set the First Circle Colour",
                                selection: $selectedColour)
                    
                    ColorPicker("Set the Second Circle Colour",
                                selection: $selectedColourTwo)
                    
                    ColorPicker("Set the Third Circle Colour",
                                selection: $selectedColourThree)
                    
                    ColorPicker("Set the Fourth Circle Colour",
